  ...
  return (
    <Layout>
      <Stack alignItems={'center'}>
        <Stack flexDirection={'row'} alignItems={'center'} gap={4} style={{
          marginBottom:"70px"
        }}>
          <img height={'70px'} src={fime} alt="FIME" />

          <div style={{margin:0}}>
            <Typography textAlign={'center'} margin={0}>Universidad Autónoma de Nuevo León</Typography>
            <Typography textAlign={'center'} margin={0}>Facultad de ingeniería Mecánica y Eléctrica</Typography>
          </div>
          <img height={'70px'} src={uanl} alt="UANL" />
        </Stack>
        <Typography textAlign={'center'}>Diseño y especificación de software</Typography>
        <Typography variant='body2' fontStyle={'italic'} color='textSecondary' textAlign={'center'}>Agosto - Diciembre 2025</Typography>

         <TableContainer>
      <Table sx={{ width: "50%", justifyContent:'center',margin:'40px 25%' }} aria-label="simple table">
        <TableHead>
          <TableRow>
        ...
        <Typography style={{margin:"150px 0 0 0"}}>Ciudad Universitaria, San Nicolás de los Garza, Nuevo León</Typography>
      </Stack>
    </Layout>
  )
}
